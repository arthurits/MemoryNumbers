...
public partial class frmSettings : Form
{
        ...
        :this()
    {
        ...
        try
        {
            ...
            this.chkStartUp.Checked = Convert.ToInt32(settings.ContainsKey("WindowPosition") ? settings["WindowPosition"] : defSets["WindowPosition"]) == 1;
    ...
    private void ApplySettings(ProgramSettings<string, string> _settings)
    {
        try
        {
            ...
            this.chkStartUp.Checked = Convert.ToInt32(_settings["WindowPosition"]) == 1;
